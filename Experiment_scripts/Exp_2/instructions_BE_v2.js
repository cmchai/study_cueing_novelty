...
var mainInstruction = [
                       ...
                       '<p>In het begin van elke taak zal je telkens twee regels zien op het scherm. Let op, deze regels zullen telkens slechts kort op het scherm verschijnen, waarna twee \
                       woorden zullen verschijnen waar je die regels moet op toepassen. Bijvoorbeeld:</p>' +

                       '<p><img src="maininstruction_CueStimImage_BE_v2.jpg" width="520" height="130"></img></p>' +
                       ...
                       //////////////////////////////////// the second page /////////////////////////////////////////
                       '<p>Zoals afgebeeld op het vorige scherm worden twee woorden gepresenteerd na het zien van de regels. In dit voorbeeld is munt iets \
...
var pracBlockInstruction = ['<p>Je krijgt zodra nog eens kort de instructive te zien. \
...
var pracMixInstruction = ['<p>Tijdens het volgende blok zal je alle taken moeten uitvoeren die je tot nu toe hebt uitgevoerd. De juiste taakinstructie zal nu verschijnen \
                           voor elke beurt. Opgelet, deze verschijnt telkens slechts één seconde waarna je meteen de taak moet uitvoeren. Net als de vorige blokken bestaat dit blok uit 60 beurten.</p>'+ 
